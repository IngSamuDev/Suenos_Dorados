...
export default function RegisterScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (!accepted) {
      validationErrors.name = validationErrors.name ?? "Acepta los términos para continuar";
    }
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: BG }}>
      ...
      >
        ...
        >
          {/* ── Header naranja — SIN botón volver ── */}
          <View style={{
            backgroundColor: ORANGE,
            paddingTop: 28, paddingBottom: 24, paddingHorizontal: 20,
            borderBottomRightRadius: 28, borderBottomLeftRadius: 28,
          }}>
          ...
          <View style={{ paddingHorizontal: 20, paddingTop: 24, gap: 14 }}>
            ...
            {FIELDS.map((field) => (
              <View key={field.key}>
                ...
                {errors[field.key] && (
                  <Text style={{ color: DANGER, fontSize: 12, marginTop: 4, marginLeft: 4 }}>
                    {errors[field.key]}
                  </Text>
                )}
              </View>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              style={{ flexDirection: "row", alignItems: "flex-start", gap: 10, marginTop: 2 }}
            >
              <View style={{
              ...
              <Text style={{ flex: 1, color: MUTED, fontSize: 13, lineHeight: 20 }}>
                Acepto los{" "}
                <Text style={{ color: ORANGE, fontWeight: "700" }}>Términos de uso</Text>
                {" "}y la{" "}
                <Text style={{ color: ORANGE, fontWeight: "700" }}>Política de privacidad</Text>
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text style={{ color: MUTED, fontSize: 14 }}>
                ¿Ya tienes cuenta?{" "}
                <Text style={{ color: ORANGE, fontWeight: "800" }}>Inicia sesión</Text>
              </Text>
            </TouchableOpacity>
