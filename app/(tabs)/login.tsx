                    ...
                    <View style={{ paddingHorizontal: 20, paddingTop: 28, gap: 16 }}>
                        ...
                        <View>
                            ...
                            <View style={{
                                ...
                                backgroundColor: WHITE,
                                borderWidth: 1.5,
                                borderColor: errors.password ? DANGER : BORDER,
                                borderRadius: 14, paddingHorizontal: 14,
                            }}>
                        ...
                        >
                            <View style={{
                                ...
                                borderWidth: 2,
                                borderColor: remember ? ORANGE : MUTED,
                                backgroundColor: remember ? ORANGE : WHITE,
                                alignItems: "center", justifyContent: "center",
                            }}>
                        ...
                        {/* Ir a registro */}
                        <TouchableOpacity
                            onPress={() => router.replace("/(tabs)/register" as any)}
                            style={{ alignItems: "center", paddingVertical: 8 }}
                        >
                            <Text style={{ color: MUTED, fontSize: 14 }}>
                                ¿No tenés cuenta?{" "}
                                <Text style={{ color: ORANGE, fontWeight: "800" }}>Registrate</Text>
                            </Text>
                        </TouchableOpacity>
